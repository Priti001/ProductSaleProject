...
def index_files(name):
    return render_template("index_Priti.html")


@app.route("/products/")
@app.route("/products/<name>")
def products(name):
    return render_template("index_Jimmy.html")
...
def barreport(): 
    # = "data/saleonly1.csv"
    return render_template("indexbar_Neha.html")

@app.route("/combine/")
@app.route("/combine/<name>")
def combine(name): 
    # = "data/saleonly1.csv"
    return render_template("index_Neha.html")
